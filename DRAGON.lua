...
names_MRahmed = database:smembers(bot_id.."DRAGON:blocname"..msg.chat_id_) or ""
...
if mrahmed2.first_name_:match("(.*)"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DRAGON:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrahmed_nnn = database:get(bot_id.."DRAGON:nump"..msg.chat_id_) or 5
local mrahmed_nnn2 = database:get(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." ahmed:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ahmed:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☉┇ تم تفعيل معاني الاسماء')
database:set(bot_id.."ahmed:Name_Bots"..msg.chat_id_,"open")
end
if text and text:match("^معني (.*)$") and database:get(bot_id.."ahmed:Name_Bots"..msg.chat_id_) == "open" then
