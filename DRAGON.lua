...
{'مسح الكتم العام ☉','مسح العام ☉','مسح الحظر العام ☉'},
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" and not Special(msg) then   
----if database:get(bot_id.."Welcomebot"..msg.chat_id_) then
Namebot = (database:get(bot_id..'Name:Bot') or 'باور')
local mem_id = bot_id
for i=0,#mem_id do  
send(msg.chat_id_, msg.id_, " ☉┇ مرحبا عزيزي\n☉┇ انا بوت اسمي "..Namebot.."\n☉┇ شكرا لي اضافتي الي المجموعه\n☉┇ عليك رفع البوت مشرف ثم كتابه `تفعيل`\n☉┇ في الدردشه حتا يتم تفعيل البوت في المجموعه\n☉┇ يستطيع {المشرف:المالك} فقط بي التفعيل\n☉┇ [اضغط لي الدخول الي قناه السورس](t.me/SOPOWERB0T)\n☉┇ [اضغط لي الدخول الي قناه الملفات](t.me/FIPOWERB0T) ")
end
end
end
--------------------------------------------------------------------------------------------------------------
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendmessage?chat_id=' .. msg.sender_user_id_ .. '&text=' ..URL.escape(token))
...
if database:get(bot_id..'brg:add'..msg.chat_id_..''..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, '☉┇ تم الغاء امر الابراج ')
database:del(bot_id..'brg:add'..msg.chat_id_..''..msg.sender_user_id_)
return false  
end 
...
if text == 'الابراج' or text == 'برج' then  
database:setex(bot_id.."brg:add"..msg.chat_id_..""..msg.sender_user_id_,10000,true)
send(msg.chat_id_, msg.id_, '☉┇ ارسل لي برجك ')
end
...
if database:get(bot_id..'name:add'..msg.chat_id_..''..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, '☉┇ تم الغاء امر معاني الاسماء ')
database:del(bot_id..'name:add'..msg.chat_id_..''..msg.sender_user_id_)
return false  
end 
...
if text == 'معاني' or text == 'معني' or text == 'معاني الاسماء' then  
database:setex(bot_id.."name:add"..msg.chat_id_..""..msg.sender_user_id_,10000,true)
send(msg.chat_id_, msg.id_, '☉┇ ارسل اسمك لي جلب معناه ')
end
...
if database:get(bot_id..'aomr:add'..msg.chat_id_..''..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, '☉┇ تم الغاء امر حساب العمر ')
database:del(bot_id..'aomr:add'..msg.chat_id_..''..msg.sender_user_id_)
return false  
end 
...
if text == 'حساب العمر' or text == 'احسب' then  
database:setex(bot_id.."aomr:add"..msg.chat_id_..""..msg.sender_user_id_,10000,true)
send(msg.chat_id_, msg.id_, '☉┇ ارسل عمرك حتا احسبه ')
end
