...
if text == 'الالعاب' and not database:get(bot_id.."coomand"..msg.chat_id_) then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'يجب ان تكون ادمن لاستخدام الاوامر')
return false
end
...
local Text =[[
مرحبا عزيزي
يمكنك الضغط علي اسم اللعبه و بدء اللعب
اول قائمه العاب ازرار كامله
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اسمايلات', callback_data="/gamesmael"},{text = 'حزوره', callback_data="/game7zora"},
},
{
{text = 'معاني', callback_data="/gamem3ne"},{text = 'العكس', callback_data="/game3ks"},
},
{
{text = 'بات ~ محيبس', callback_data="/gamebat"},{text = 'تخمين', callback_data="/gamet5menn"},
},
{
{text = 'الانجلزيه', callback_data="/gameeng"},{text = 'امثلا', callback_data="/gamemsla"},
},
{
{text = 'الاختلاف', callback_data="/game5laf"},{text = 'رياضيات', callback_data="/game7s"},
},
{
{text = 'العاب متطوره', callback_data="/game"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = 'الالعاب العاديه', callback_data="/gameso"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يرتبها » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙الف مبروك لقد فزت \n 𖡞︙للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Speed:Tr'..msg.chat_id_,true)
end 

if Text == '/game7zora' then
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙الف مبروك لقد فزت \n 𖡞︙للعب مره اخره ارسل »{ حزوره }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:Hzora'..msg.chat_id_,true)
end 

if Text == '/gamem3ne' then
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يدز معنى السمايل » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يدز العكس » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖡞︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 𖡞︙مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖡞︙تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖡞︙اوبس لقد خسرت في اللعبه \n 𖡞︙حظآ اوفر في المره القادمه \n 𖡞︙كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' 𖡞︙اوبس تخمينك غلط \n 𖡞︙ارسل رقم تخمنه مره اخرى ')
end
end
end
end
if Text == '/gamet5menn' then   
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Num = math.random(1,20)
database:set(bot_id.."GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,'\n 𖡞︙اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 𖡞︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 𖡞︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 𖡞︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖡞︙مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n 𖡞︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖡞︙للاسف لقد خسرت \n 𖡞︙المحيبس بل ايد رقم { '..GETNUM..' }\n 𖡞︙حاول مره اخرى للعثور على المحيبس')
end
end
end

if Text == '/gamebat' then
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then   
Num = math.random(1,6)
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
 𖡞︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖡞︙الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يدز الاختلاف » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙حل المسأله الرياضيه  » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙ترجم الكلمات الاتيه  » {'..name..'}')return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞︙اسرع واحد يكمل المثل » {'..name..'}')return false
end
------------------------------------------------------------------------
