...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع مطور ثاني") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data=msg.sender_user_id_.."/mute-name"},{text = 'التوحيد', callback_data=msg.sender_user_id_.."/sofi"},{text = 'تنبيه الأسماء', callback_data=msg.sender_user_id_.."/change-names"},
},
{
{text = 'تنبيه المعرف', callback_data=msg.sender_user_id_.."/change-id"},{text = 'تنبيه الصور', callback_data=msg.sender_user_id_.."/change-photo"},
},
{
...
{
{text = '⌯ قفل و القفل ⌯', callback_data=msg.sender_user_id_.."/help"},{text = 'تعطيل و تفعيل', callback_data=msg.sender_user_id_.."/help2"},
},
}
...
{
{text = 'قفل و القفل', callback_data=msg.sender_user_id_.."/help1"},{text = '⌯ تعطيل و تفعيل ⌯', callback_data=msg.sender_user_id_.."/help"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{
{text = '⌯ ❶️❶ ⌯', callback_data=msg.sender_user_id_.."/help"},{text = '❷❷', callback_data=msg.sender_user_id_.."/help4"},
},
{
{text = '❸❸', callback_data=msg.sender_user_id_.."/help5"},{text = '❹❹', callback_data=msg.sender_user_id_.."/help6"},
},
...
keyboard.inline_keyboard = {
{
{text = '❶️❶', callback_data=msg.sender_user_id_.."/help3"},{text = '⌯ ❷❷ ⌯', callback_data=msg.sender_user_id_.."/help"},
},
{
{text = '❸❸', callback_data=msg.sender_user_id_.."/help5"},{text = '❹❹', callback_data=msg.sender_user_id_.."/help6"},
},
...
{
{text = '⌯ ❸❸ ⌯', callback_data=msg.sender_user_id_.."/help"},{text = '❹❹', callback_data=msg.sender_user_id_.."/help6"},
},
{
{text = 'اوامر التسليه', callback_data=msg.sender_user_id_.."/help7"},
},
...
{
{text = '❸❸', callback_data=msg.sender_user_id_.."/help5"},{text = '⌯ ❹❹ ⌯', callback_data=msg.sender_user_id_.."/help"},
},
{
{text = 'اوامر التسليه', callback_data=msg.sender_user_id_.."/help7"},
},
...
{
{text = '⌯ اوامر التسليه ⌯', callback_data=msg.sender_user_id_.."/help"},
},
{
{text = 'قفل و القفل', callback_data=msg.sender_user_id_.."/help1"},{text = 'تعطيل و تفعيل', callback_data=msg.sender_user_id_.."/help2"},
},
...
keyboard.inline_keyboard = {
{
{text = '❶️❶', callback_data=msg.sender_user_id_.."/game1"},{text = '❷❷', callback_data=msg.sender_user_id_.."/game2"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{
{text = '⌯ ❶️❶ ⌯', callback_data=msg.sender_user_id_.."/game"},{text = '❷❷', callback_data=msg.sender_user_id_.."/game2"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{
{text = '❶️❶', callback_data=msg.sender_user_id_.."/game1"},{text = '⌯ ❷❷ ⌯', callback_data=msg.sender_user_id_.."/game"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '🔙 القائمة الرئيسيه 🔙', callback_data=msg.sender_user_id_.."/add"},
},
{
{text = '𓆩𝑷𝑶𝑾𝑬𝑹𓆪', url="t.me/SOPOWERB0T"},
},
...
{
{text = 'تنبيه المعرف', callback_data="/change-id"},{text = 'تنبيه الصور', callback_data=msg.sender_user_id_.."/change-photo"},
},
{
{text = '𓆩𝑷𝑶𝑾𝑬𝑹𓆪', url="t.me/SOPOWERB0T"},
},
