...
if text == 'كيب' or text == "☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉" or text == 'كيبورد المطور الاساسي' then  
if DevSoFi(msg) then
...
{'☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉'},
{'اوامر الرتب العامه','اوامر الاشتراك الاجباري'},
{'اوامر الاذاعه','اوامر الردود'},
{'اوامر العام','اوامر ملفات البوت'},
{'☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉'},
...
send_inline_key(msg.chat_id_,bl6,keyboard6)
end end
if Chat_Type == 'UserBot' then
if text == '/start' then
