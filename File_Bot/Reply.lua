...
if text == 'انا مين' and DevBOYKAW(msg) then 
send(msg.chat_id_,msg.id_, 'أنت مطوري الغالي 😊') 
return false
end

if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, 'أنت مالك البوت ❤') 
return false
end

if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, 'أنت مالك البوت يقلبي ❤') 
return false
end
